    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_feedback_log:
                ...
                File trackerLog = new File(filePath + File.separator + "MokoTracker+.txt");
                File trackerLogBak = new File(filePath + File.separator + "MokoTracker+.txt.bak");
                ...
                StringBuilder mailContent = new StringBuilder("MokoTracker+_");
